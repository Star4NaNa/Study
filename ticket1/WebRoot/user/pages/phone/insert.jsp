...
function cancel(){
  ...
  <body style="background:url(${pageContext.request.contextPath}/images/topbg.gif) repeat-x;">
   ...
   <div class="rightbar">
      ...
      <form id="jqueryform" action="${pageContext.request.contextPath}/phone/insert" method="post">
        
        <table class="tablelist">
           
          <tr>
            <td>联系人姓名</td>
            <td><input name="lphone.phoneName" type="text"/></td>
          </tr>
          
          <tr>
            <td>联系人电话</td>
            <td><input name="lphone.phoneNum" type="text"/></td>
          </tr>
